  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {Array.from({ length: cards }).map((_, i) => (
        <div
          key={i}
          className="space-y-4 rounded-3xl border border-slate-200/80 bg-white p-5 dark:border-slate-800 dark:bg-[#0c0c0f]"
        >
...
export function TableSkeleton({ rows = 6, cols = 5 }: { rows?: number; cols?: number }) {
  return (
    <div className="overflow-hidden rounded-3xl border border-slate-200/80 bg-white dark:border-slate-800 dark:bg-[#0c0c0f]">
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
      {Array.from({ length: cards }).map((_, i) => (
        <div
          key={i}
          className="space-y-3 rounded-2xl border border-slate-200/80 bg-white p-4 dark:border-zinc-800 dark:bg-[#0c0c0f]"
        >
          <Skeleton className="h-3 w-24" />
...
export function SettingsTabsSkeleton() {
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4 rounded-3xl border border-slate-200/80 bg-white p-6 dark:border-slate-800 dark:bg-[#0c0c0f]">
